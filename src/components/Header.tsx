  ...
  const NAV_GROUPS: { label: string; icon: any; items?: { label: string; path: string; icon: any }[]; path?: string }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Генератор Оперативних Розкладів', path: '/dispatch/generator', icon: RefreshCw },
    ...
    },
    {
      ...
      icon: Layers,
      items: [
        { label: 'Конструктор Нарядів (Duties)', path: '/planning/duties', icon: Bus },
        { label: 'Сітка Рейсів (Trip Grid)', path: '/planning/trips', icon: TableIcon },
